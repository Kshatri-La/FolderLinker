...
- **Visual Drag & Drop Tracking:** Hovering files over a destination row vividly highlights the exact sub-folder intercepting the drop, ensuring surgical precision.
